    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="hidden lg:block absolute right-12 bottom-32 z-[2]"
        >
          <div className="glass-card rounded-2xl px-5 py-4 shadow-xl space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{SITE_BARANGAY} — 24/7</p>
              </div>
            </div>
