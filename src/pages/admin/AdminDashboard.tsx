      ...
      <AdminLayout>
        <div className="flex h-full min-h-[400px] w-full items-center justify-center">
          <div className="flex flex-col items-center justify-center gap-4">
            <div className="h-12 w-12 rounded-2xl bg-[#800000]/10 flex items-center justify-center shadow-inner">
              <Activity className="h-6 w-6 animate-pulse text-[#800000]" />
            </div>
            <p className="text-[13px] font-medium tracking-wide text-slate-500 uppercase">Synchronizing Systems...</p>
          </div>
        </div>
      </AdminLayout>
    );
      ...
      <div className="flex flex-col h-full space-y-8 w-full mx-auto max-w-[1920px]">
        ...
        <section className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="space-y-1.5">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-emerald-50 border border-emerald-100 text-emerald-700 text-[11px] font-bold tracking-widest uppercase mb-2">
            ...
            <p className="text-[14px] text-slate-500 max-w-[600px] leading-relaxed">
              Real-time oversight of hospital operations, AI triage assessments, and comprehensive user metrics.
            </p>
          </div>
          <div className="hidden md:flex flex-col items-end">
            <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Current Timestamp</div>
            <div className="text-[15px] font-medium text-slate-700 mt-0.5">{format(new Date(), "PPpp")}</div>
          </div>
        </section>

        {/* Key Metrics Grid */}
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          <div className="group relative flex flex-col bg-white rounded-2xl p-5 border border-slate-200 shadow-sm transition-all hover:shadow-md hover:border-[#800000]/20 overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4 relative z-10">
              <div className="h-10 w-10 shrink-0 bg-slate-50 border border-slate-100 rounded-xl flex items-center justify-center text-slate-600 group-hover:text-[#800000] group-hover:bg-[#800000]/5 transition-colors">
                <Users className="h-5 w-5" strokeWidth={1.5} />
              </div>
              <div>
                <p className="text-[12px] font-semibold text-slate-500 uppercase tracking-wider">Total Accounts</p>
              </div>
            </div>
            <div className="mt-auto relative z-10">
              <h2 className="text-[34px] font-bold text-slate-900 tracking-tight leading-none mb-2">{stats.usersTotal}</h2>
          ...
          <div className="group relative flex flex-col bg-white rounded-2xl p-5 border border-slate-200 shadow-sm transition-all hover:shadow-md hover:border-[#800000]/20 overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4 relative z-10">
              <div className="h-10 w-10 shrink-0 bg-slate-50 border border-slate-100 rounded-xl flex items-center justify-center text-slate-600 group-hover:text-blue-600 group-hover:bg-blue-50 transition-colors">
                <HeartPulse className="h-5 w-5" strokeWidth={1.5} />
              </div>
              <div>
                <p className="text-[12px] font-semibold text-slate-500 uppercase tracking-wider">Active Patients</p>
              </div>
            </div>
            <div className="mt-auto relative z-10 flex items-end justify-between">
              <h2 className="text-[34px] font-bold text-slate-900 tracking-tight leading-none">{stats.patientsCount}</h2>
              <div className="flex items-center text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-md text-[11px] font-bold">
          ...
          <div className="group relative flex flex-col bg-white rounded-2xl p-5 border border-slate-200 shadow-sm transition-all hover:shadow-md hover:border-[#800000]/20 overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4 relative z-10">
              <div className="h-10 w-10 shrink-0 bg-slate-50 border border-slate-100 rounded-xl flex items-center justify-center text-slate-600 group-hover:text-amber-600 group-hover:bg-amber-50 transition-colors">
                <Calendar className="h-5 w-5" strokeWidth={1.5} />
              </div>
              <div>
                <p className="text-[12px] font-semibold text-slate-500 uppercase tracking-wider">Pending Consults</p>
              </div>
            </div>
            <div className="mt-auto relative z-10 flex items-end justify-between">
              <h2 className="text-[34px] font-bold text-slate-900 tracking-tight leading-none">{stats.pendingTeleconsults}</h2>
          ...
          <div className="group relative flex flex-col bg-white rounded-2xl p-5 border border-slate-200 shadow-sm transition-all hover:shadow-md hover:border-red-500/30 overflow-hidden">
        ...
        <section className="flex-1 min-h-[350px] bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col relative z-10">
          <div className="h-[68px] border-b border-slate-100 flex items-center justify-between px-6 bg-slate-50/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-[15px] font-bold tracking-tight text-slate-900">Live Audit Trail</h3>
                <p className="text-[11px] font-medium text-slate-500 uppercase tracking-wider">HIPAA Compliance Logging</p>
              </div>
            </div>
            <Link to="/admin/audit-logs" className="flex items-center gap-1.5 text-[12px] font-semibold text-slate-600 hover:text-slate-900 bg-white border border-slate-200 px-3 py-1.5 rounded-lg shadow-sm transition-all hover:shadow">
            ...
            <table className="w-full text-left border-collapse border-0">
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50/80">
                  <th className="py-3 px-6 text-[11px] font-bold uppercase tracking-widest text-slate-400 whitespace-nowrap w-[200px]">Timestamp</th>
                  <th className="py-3 px-6 text-[11px] font-bold uppercase tracking-widest text-slate-400 whitespace-nowrap">Operator</th>
                  <th className="py-3 px-6 text-[11px] font-bold uppercase tracking-widest text-slate-400 whitespace-nowrap">Action Type</th>
                  <th className="py-3 px-6 text-[11px] font-bold uppercase tracking-widest text-slate-400 whitespace-nowrap">Resource Target</th>
                </tr>
              </thead>
                    ...
                    <tr key={log.id} className="hover:bg-slate-50/50 transition-colors group">
                      <td className="py-3 px-6">
                        <div className="flex items-center gap-2 text-[13px] font-medium text-slate-600">
                          <Clock className="h-3.5 w-3.5 text-slate-300 group-hover:text-[#800000]" />
                          {format(new Date(log.created_at), "MMM d, h:mm a")}
                        </div>
                      </td>
                      <td className="py-3 px-6">
                        <div className="flex items-center gap-2">
                          <div className="h-6 w-6 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-[9px] font-bold text-slate-500">
                      ...
                      <td className="py-3 px-6">
                        <div className="text-[13px] font-medium text-slate-500 truncate max-w-[250px]">
                          {log.resource}
                        </div>
                      </td>
                    </tr>
